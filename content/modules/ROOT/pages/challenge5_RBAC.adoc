== Challenge 5: Setup Role Base Access Control (RBAC)
...
* **You**: "Alright JHomer, let’s set up Role-Based Access Control."
...
* **Homer**: “Wait, so I can’t press all the buttons? But pressing buttons is my favorite part of the day!”*

=== Task 2: Creating Roles from the RBAC Administration UI

* **You**: "Alright Homer, your next task is to grant the second user in the GitHub organization the ability to create, read, and update catalog entities. Let’s navigate to the RBAC Administration UI and set up these permissions."

TIP: You can refer to the RHDH documentation to read more about RBAC in Section 10.3. Managing role-based access controls (RBAC) using the Red Hat Developer Hub Web UI: https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.2/html-single/administration_guide_for_red_hat_developer_hub/index#proc-rbac-ui-manage-roles_assembly-rhdh-integration-aks. 
