...
NOTE: The *Catalog* is built around the concept of metadata YAML files stored together with the code, you can explore the YAML file used to generate the *rh-one* application in this link:{gitlab_url}/rhdh/rh1-software-templates/blob/main/catalogs.yaml[Yaml Fle,window=_blank]
