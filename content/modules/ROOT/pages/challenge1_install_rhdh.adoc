...
* **You**: “Focus, Homer. We’ll stick with the name **rhdh**. Here are the login details you’ll need:”
...
* **You**: "You'll see two options on the authentication page: one is to use **GitHub**, which will fail because we have not configured authentication through **GitHub** yet, and the other is to use a **Guest** account. This is highly not desired by **Globex Corp** as they want only authorized users to access the **Red Hat Developer Hub**."
