...
TIP: Feel free tp explore both repositories by accessing the link:{gitlab_url}/development/my-quarkus-app[Source Code Repo] and the link:{gitlab_url}/development/my-quarkus-app-gitops[GitOps Manifests Repo]
