...
TIP: Feel free tp explore both repositories by accessing the link:https://gitlab-gitlab.apps.cluster-677l9.sandbox2418.opentlc.com/development/my-quarkus-app[Source Code Repo,window=_blank] and the link:https://gitlab-gitlab.apps.cluster-677l9.sandbox2418.opentlc.com/development/my-quarkus-app-gitops[GitOps Manifests Repo,window=_blank]
...
. The *Links* tile: Gives you access to your Cloud Developmenet Environment link:https://developers.redhat.com/products/openshift-dev-spaces/overview[Red Hat OpenShift Dev Spaces,window=_blank]. You can choose your preferred IDE, either Microsoft Visual Studio Code or JetBrains IntelliJ IDEA.
