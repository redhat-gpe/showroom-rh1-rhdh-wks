...
. Process a config-info yaml file containing the component definition, which is hosted on Gitlab.
. Register a new component in the RHDH Catalog
* You will need to use the the *catalog:register* action to set up the template steps.
