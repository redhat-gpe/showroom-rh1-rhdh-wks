...
NOTE: Only one member of your team needs to create the GitHub Organization. The Organization Owner is responsible for creating the GitHub Application and inviting team members to the Organization. There should be at least two members in the Organization.
